...
export const weatherCategory: MambaCategoryData = {
  slug: "weather",
  title: "Weather",
  ...
  variants: [
    {
      ...
      storyName: "weather1",
      centered: true,
      sourceHtmlPath: "src/storybook/mamba/source/weather/weather1.component.html",
      sourceTsPath: "src/storybook/mamba/source/weather/weather1.component.ts",
      upstreamHtmlPath: "src/app/components/weather/weather1/weather1.component.html",
      upstreamTsPath: "src/app/components/weather/weather1/weather1.component.ts",
      renderedHtml: String.raw`<div class="max-w-md p-8 mx-auto rounded-lg bg-gray-900 text-gray-100">
	<div class="flex justify-between space-x-8">
		<div class="flex flex-col items-center">
			<svg class="w-24 h-24 p-2 text-yellow-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
`,
    },
    {
      ...
      storyName: "weather2",
      centered: true,
      sourceHtmlPath: "src/storybook/mamba/source/weather/weather2.component.html",
      sourceTsPath: "src/storybook/mamba/source/weather/weather2.component.ts",
      upstreamHtmlPath: "src/app/components/weather/weather2/weather2.component.html",
      upstreamTsPath: "src/app/components/weather/weather2/weather2.component.ts",
      renderedHtml: String.raw`<div class="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 bg-gray-900 text-gray-100">
	<div class="text-center">
		<h2 class="text-xl font-semibold">Dubai</h2>
		<p class="text-sm text-gray-400">July 29</p>
	</div>
	<svg class="w-32 h-32 p-6 text-yellow-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
		<path d="M256,104c-83.813,0-152,68.187-152,152s68.187,152,152,152,152-68.187,152-152S339.813,104,256,104Zm0,272A120,120,0,1,1,376,256,120.136,120.136,0,0,1,256,376Z"></path>
		<rect width="32" height="48" x="240" y="16"></rect>
		<rect width="32" height="48" x="240" y="448"></rect>
		<rect width="48" height="32" x="448" y="240"></rect>
...
`,
    },
    {
      ...
      storyName: "weather3",
      centered: true,
      sourceHtmlPath: "src/storybook/mamba/source/weather/weather3.component.html",
      sourceTsPath: "src/storybook/mamba/source/weather/weather3.component.ts",
      upstreamHtmlPath: "src/app/components/weather/weather3/weather3.component.html",
      upstreamTsPath: "src/app/components/weather/weather3/weather3.component.ts",
      renderedHtml: String.raw`<div class="max-w-xs overflow-hidden rounded-lg shadow-lg bg-gray-900 text-gray-100">
	<div class="flex items-end justify-end h-32 p-4 bg-gray-500 bg-center bg-cover" style="background-image: url(https://source.unsplash.com/300x150/?skyline)">
		...
		<div class="flex flex-col flex-1 gap-4">
			<div class="flex justify-between">
				<div class="flex gap-2">
					<span class="text-5xl font-semibold">36°</span>
					<span class="text-lg text-gray-400">/ 28°</span>
				</div>
				<svg class="w-12 h-12 text-yellow-400 fill-current shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
					<path d="M256,104c-83.813,0-152,68.187-152,152s68.187,152,152,152,152-68.187,152-152S339.813,104,256,104Zm0,272A120,120,0,1,1,376,256,120.136,120.136,0,0,1,256,376Z"></path>
					<rect width="32" height="48" x="240" y="16"></rect>
					<rect width="32" height="48" x="240" y="448"></rect>
					<rect width="48" height="32" x="448" y="240"></rect>
