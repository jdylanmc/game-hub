...
import {
  mambaCategorySummaries,
  mambaSourceMeta,
} from '../../storybook/mamba/generated/index.generated';
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <Card as="section" className="p-6">
          ...
          <p className="mt-6 text-sm leading-7 text-slate-400">
            Angular bindings, loops, and theme tokens are resolved ahead of time into static
            React-renderable HTML snapshots. Interactive upstream behaviors remain visual-only.
          </p>
        </Card>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <Card as="section" className="p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-400">
            Review and navigation primitives are intentionally surfaced first because they
            map most directly to Game Hub trust, browsing, and menu flows.
          </p>
        </Card>
        ...
        <Card as="section" className="p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-400">
            The curated Game Hub marketing story demonstrates how the most relevant Mamba
            homepage building blocks can compose a browse-first landing page without
            removing any of the canonical snapshot stories.
          </p>
        </Card>
      </div>
    </StorySurface>
