# Orbital Stack Workspace Agent Guide

`@game-hub/orbital-stack` is a placeholder Three.js game workspace. Read the
...
memory and add only reusable Orbital Stack conventions to this file.
